...
public static class HttpRequestLogEntryDeserializer
{
    ...
    /// <summary>
    /// Deserializes a stream of Apache Common Log Format (CLF) entries into a list of <see cref="LogEntry"/> objects.
    ...
    /// <returns>A list of deserialized <see cref="LogEntry"/> objects.</returns>
    /// <exception cref="BadApacheClfFileException">Thrown when one or more log entries throw an exception.</exception>
    public static List<LogEntry> DeserializeApacheClfList(Stream logContent)
    {
    ...
    /// <summary>
    /// Deserializes a log entry in the Apache Common Log Format (CLF) into an <see cref="LogEntry"/> object.
    ...
    /// <returns>An <see cref="LogEntry"/> object containing the parsed data from the log entry.</returns>
    ...
    public static LogEntry DeserializeApacheClf(string logEntry)
    {
